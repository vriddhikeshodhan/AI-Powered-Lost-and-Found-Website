...
// This component will dynamically inject our plain CSS into the document's head.
// This is a way to include plain CSS while keeping everything in one .jsx file
// as per your request to avoid Tailwind.
const PageStyler = () => {
  useLayoutEffect(() => {
    ...
    <div className="landing-container">
      ...
      <main className="landing-main">
        ...
        <div className="action-buttons-container">
          <a href="#/lost" className="action-btn lost-btn">
            Lost?
          </a>
          <a href="#/found" className="action-btn found-btn">
            Found?
          </a>
        </div>
      </main>
